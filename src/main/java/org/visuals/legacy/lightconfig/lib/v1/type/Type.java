...
public abstract class Type<T> {
    public abstract @Nullable T read(final ConfigDeserializer<?> deserializer, final String name);

    public abstract void write(final ConfigSerializer<?> serializer, final String name, final T value);
}
