...
public class SimpleButton extends Gidget {
    ...
    public SimpleButton(
        ...
        this.text = Text.builder(text)
                ...
                .build(Minecraft.getInstance().textRenderer);
        this.resize(Math.max(this.text.box().width() + DEFAULT_PADDING, DEFAULT_WIDTH), this.box.height());
        this.onClick = onClick;
    }

    public static Builder builder(final TextComponent text, final Consumer<SimpleButton> onClick) {
    ...
    public static class Builder {
        ...
        public Builder(final TextComponent text, final Consumer<SimpleButton> onClick) {
            this.text = text;
            this.onClick = onClick;
        }
