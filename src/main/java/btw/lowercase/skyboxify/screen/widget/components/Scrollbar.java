...
public class Scrollbar extends Gidget {
    public static final Id BAR_TEXTURE = Skyboxify.locationOrNull("widget/scrollbar/bar");
    ...
    private class Knob extends Gidget {
        public static final Id KNOB_TEXTURE = Skyboxify.locationOrNull("widget/scrollbar/knob");
