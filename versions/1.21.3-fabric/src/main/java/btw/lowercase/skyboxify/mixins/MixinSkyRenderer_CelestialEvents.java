...
public abstract class MixinSkyRenderer_CelestialEvents {
    ...
    private boolean skyboxify$toggleSun(final SkyRenderer instance, final float rainBrightness, final Tesselator tesselator, final PoseStack poseStack) {
    ...
    private boolean skyboxify$toggleMoon(final SkyRenderer instance, final int moonPhase, final float rainBrightness, final Tesselator tesselator, final PoseStack poseStack) {
    ...
    private boolean skyboxify$toggleStars(final SkyRenderer instance, final FogParameters fogParameters, final float starBrightness, final PoseStack poseStack) {
